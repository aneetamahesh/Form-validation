...
checkUserName = () => 
{
  ...
  {
    return error(userName, "Minimum 5 Characters \n" + showSuggestions());
  } else {
...
checkEmail = () => 
{
  ...
  else if (regx.test(emnoval))
  {
   ...
   {
    return error(emtxt, "aneeta.m@mca.christuniversity.in, aneeta@christuniversity.in");
  }
};
...
checkPassword = () => 
{
  ...
  if (
   ...
   {
    return error(password,' min 1 [a-z],min 1 [A-Z]min 1[0-9] min 1(~`!@#$%^&*()-_+={}[]|;:"<>,./?-_+={}(){}|/\)'
    );
  }
};
